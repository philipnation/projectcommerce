                	...
                	<div class="touch-container row justify-content-center">
                		<div class="col-md-9 col-lg-7">
                			...
                			<div class="contact-form mb-2"><!--was form-->
								<div class="text-center">
	                				<button class="btn btn-outline-primary-2 btn-minwidth-sm">
                                ...
                                <div class="row">
                                  <div class="col-md-6 offset-md-3">
                                    <div class="text-center">
                                      <h3>ENERGY CHLEEEN WASTE</h3>
                                      <p>No.3 Nsugbe street Awada</p>
                                      <hr>
                                      <h3>Receipt</h3>
                                    </div>
                                    <div>
                                      <p><strong>Customer Name: Lorem name</strong></p>
                                      <p><strong> Address: Address</strong></p>
                                      <p>Order id: #98433223</p>
                                      <hr>
                                      <table class="table">
                                            ...
                                            $total_price = 0;	
                                                foreach ($_SESSION["shopping_cart"] as $product){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan='2'>&#8358;$product[item_price]</td>
                                                    </tr>";
                                                }
                                        ?>
                                          <tr>
                                      ...
                                      <p style="color:red;" class="small">
                                        Payment on delivery will be collected immediatley on delivery.
                                      </p>
                                    </div>
                                  </div>
                                </div>
